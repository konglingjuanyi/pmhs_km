...
//                disable : function(){},
       ...
       function Input(c,setting, fieldName,cfg){
            ...
            if ( setting.asLabel){
                ...
                ele = $('<input type="text" class="ie6input" '  + attr +  '></input>');
            } else {
                ele = $('<textarea id="' + fieldName + '" class="ie6input" '  + attr + '></textarea>');
            }
...
//                        hideHUD($(this),true);
        ...
        function NewList(c, cfg, fieldName){
            ...
            var displayCss = setting.disabled ? "display:none;" : "";
            c.html("<div class='list' id='" + fieldName  + "' style='" + displayCss + "'>" + spans + newLine +  "<input class='list-input' type='text' size='1'></div>");
            var ele = $("div", c);
