  ...
  var addUser = function() {
    ...
    var editForm = new Ext.FormPanel( {
      ...
      , {
        ...
        items : [
          {boxLabel: '一般操作人员', name: 'typeList', inputValue : 1},
          {boxLabel: '医生', name: 'typeList', inputValue : 2},
          {boxLabel: '护士', name: 'typeList', inputValue : 4},
          {boxLabel: '公卫医师', name: 'typeList', inputValue : 8}
        ]
      }
      , {
        fieldLabel : '所属组织机构',
